...
<div class="email-container">
  ...
  ?>
  <h1>Inscription</h1>
  <form class="login-form" method="post" action="process_register">
    ...
    <input type="date" id="dateOfBirth" name="date_of_birth" placeholder="Date de naissance :" required>
    <div class="email-div">
